...
def test_uri_no_parse_defaults():
    ...
    assert_equal(String(uri.full_uri()), "http://example.com")
    assert_equal(String(uri.scheme()), "http")
    assert_equal(String(uri.host()), "127.0.0.1")
    assert_equal(String(uri.path()), "/")

def test_uri_parse_http_with_port():
    var uri = URI("http://example.com:8080/index.html")
    _ = uri.parse()
    assert_equal(String(uri.scheme()), "http")
    assert_equal(String(uri.host()), "example.com:8080")
    assert_equal(String(uri.path()), "/index.html")
    assert_equal(String(uri.path_original()), "/index.html")
...
def test_uri_parse_https_with_port():
    ...
    _ = uri.parse()
    assert_equal(String(uri.scheme()), "https")
    assert_equal(String(uri.host()), "example.com:8080")
    assert_equal(String(uri.path()), "/index.html")
    assert_equal(String(uri.path_original()), "/index.html")
    assert_equal(String(uri.request_uri()), "/index.html")
...
def test_uri_parse_http_with_path():
    ...
    _ = uri.parse()
    assert_equal(String(uri.scheme()), "http")
    assert_equal(String(uri.host()), "example.com")
    assert_equal(String(uri.path()), "/index.html")
    assert_equal(String(uri.path_original()), "/index.html")
    assert_equal(String(uri.request_uri()), "/index.html")
    assert_equal(uri.is_https(), False)
...
def test_uri_parse_http_basic_www():
    ...
    _ = uri.parse()
    assert_equal(String(uri.scheme()), "http")
    assert_equal(String(uri.host()), "www.example.com")
    assert_equal(String(uri.path()), "/")
    assert_equal(String(uri.path_original()), "/")
    assert_equal(String(uri.request_uri()), "/")
    assert_equal(String(uri.http_version()), "HTTP/1.1")
